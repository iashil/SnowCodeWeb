...
const translations: Record<string, string> = {
  ...
  "No projects yet. Add the first story.": "لا توجد مشاريع بعد. أضف أول مشروع.", "Add the first team member.": "أضف أول عضو للفريق.", "Your inbox is quiet for now.": "صندوق الرسائل فارغ حاليًا.",
